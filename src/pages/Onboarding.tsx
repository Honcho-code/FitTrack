      ...
      <div className="onboarding-container">
        ...
        <div className="flex-1 px-6 onboarding-wrapper">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-5">
                <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center">
                  <User className="text-emerald-600 size-6 dark:text-emerald-400" />
                </div>
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    This helps us calculate your need
                  </p>
                </div>
              </div>
              <Input
          ...
          {step === 2 && (
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-5">
                <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center">
                  <ScaleIcon className="text-emerald-600 size-6 dark:text-emerald-400" />
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-slate-800 dark:text-white">
                    Your Measurement
          ...
          {step === 3 && (
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-5">
                <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center">
                  <Target className="text-emerald-600 size-6 dark:text-emerald-400" />
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-slate-800 dark:text-white">
                    What's your goal?
        ...
        <div className="p-6 pb-10 onboarding-wrapper">
          <div className="flex gap-3 lg:justify-end">
            {step > 1 &&(
              <Button variant="secondary" onClick={()=>setStep(step > 1 ? step - 1 :1)} className="max-lg:flex-1 lg:px-10 cursor-pointer">
            ...
            <Button variant="primary" onClick={handleNext} className="max-lg:flex-1 lg:px-10 cursor-pointer">
                <span className="flex items-center justify-center gap-2">
                  <p>{step === totalSteps ? 'Get Started' : 'Continue'}</p>
